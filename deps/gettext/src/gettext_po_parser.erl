...
-file("src/gettext_po_parser.yrl", 49).
...
-file("src/gettext_po_parser.erl", 192).
...
yeccpars2_0(_S, '$end', Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccpars2_1(_S, '$end', [0 | Ss], NewStack, T, Ts, Tzr);
...
yeccpars2_2(_S, '$end', Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccpars2_21(_S, '$end', [2 | Ss], NewStack, T, Ts, Tzr);
...
yeccpars2_4(S, msgid, Ss, Stack, T, Ts, Tzr) ->
 yeccpars1(S, 7, Ss, Stack, T, Ts, Tzr);
yeccpars2_4(_, _, _, _, T, _, _) ->
 yeccerror(T).

yeccpars2_5(S, comment, Ss, Stack, T, Ts, Tzr) ->
 yeccpars1(S, 5, Ss, Stack, T, Ts, Tzr);
...
yeccgoto_comments(2, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_4(4, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_comments(5=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_6(_S, Cat, Ss, Stack, T, Ts, Tzr).
...
yeccgoto_translation(0, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_2(2, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_translation(2, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_2(2, Cat, Ss, Stack, T, Ts, Tzr).

yeccgoto_translations(0=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_1(_S, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_translations(2=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_21(_S, Cat, Ss, Stack, T, Ts, Tzr).

-compile({inline,'yeccpars2_0_$end'/1}).
-file("src/gettext_po_parser.yrl", 6).
...
-file("src/gettext_po_parser.yrl", 40).
...
-file("src/gettext_po_parser.yrl", 42).
...
-file("src/gettext_po_parser.yrl", 37).
...
-file("src/gettext_po_parser.yrl", 11).
...
-file("src/gettext_po_parser.yrl", 18).
...
-file("src/gettext_po_parser.yrl", 27).
...
-file("src/gettext_po_parser.yrl", 32).
...
-file("src/gettext_po_parser.yrl", 29).
...
-file("src/gettext_po_parser.yrl", 8).
...
-file("src/gettext_po_parser.yrl", 63).
